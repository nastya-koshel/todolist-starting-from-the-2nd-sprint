...
import {TodolistType} from "../types.tsx";
import {
...
test('correct todolist should be deleted', () => {
    ...
    //или const endState = todolistsReducer(startState, deleteTodolistActionCreator(todolistId1))
...
test('correct todolist should be created', () => {
    ...
    const endState = todolistsReducer(startState, createTodolistAC({id: v1(), title}))
